...
before packages are loaded."
  ...
  ;; From https://practicalli.github.io/spacemacs/org-mode/todo-states-customise.html
  (with-eval-after-load 'org
    (setq org-todo-keywords '((sequence "TODO" "PROG" "|" "DONE" "WONTDO")))
    (setq org-todo-keyword-faces
          '(("TODO" . "#dc752f")
            ...
            ("WONTDO" . "ForestGreen"))))
  ;; End added by Dio
  ; (add-to-list 'company-c-headers-path-system "/home/dionisius/Documents/mestrado_2019_02/egg_detection/include/" )
  (add-hook 'c-mode-hook
            (lambda () (setq flycheck-clang-include-path
                             (list (expand-file-name "/home/dionisius/Documents/mestrado_2019_02/egg_detection/include/")))))
  )
