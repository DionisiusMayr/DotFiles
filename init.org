#/home/dionisius/repos/DotFiles+TITLE Emacs configuration
...
+ It is necessary to pull the container (=docker pull emacslsp/lsp-docker-langservers=) before using this.
+ Didn't work.
#+begin_src emacs-lisp
  ;; Uncomment the next line if you are using this from source
  ;; (add-to-list 'load-path "/home/dionisius/repos/lsp-docker")
  ;; (use-package lsp-docker)
  ;; (require 'lsp-docker)

  ;; (defvar lsp-docker-client-packages
  ;;   '(lsp-css lsp-clients lsp-bash lsp-go lsp-pylsp lsp-html
  ...
  ;;  ;; Need to register the project folders here
  ;;  :path-mappings '(("/home/dionisius/Desktop/dio" . "/projects"))
