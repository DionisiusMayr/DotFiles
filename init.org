...
#+begin_src emacs-lisp
  (use-package general
    ...
    (dio/leader-keys
      ...
      "f p" '((lambda() (interactive)(find-file "~/.emacs.d/init.org")) :which-key "init.org")
...
#+begin_src emacs-lisp
  ...
  (dio/leader-keys
    ...
    "a t" '(:ignore t :which-key "treemacs")
    "a t 1" '(treemacs-delete-other-windows :which-key "treemacs-delete-other-windows")
    "a t B" '(treemacs-bookmark :which-key "treemacs-bookmark")
    "a t t" '(treemacs :which-key "treemacs")
    "a t C-t" '(treemacs-find-file :which-key "treemacs-find-file")
    "a t M-t" '(treemacs-find-tag :which-key "treemacs-find-tag")
  )
...
(use-package org
  ...
  (setq org-log-done 'time)  ;; TODO: Do i need the 'time?
